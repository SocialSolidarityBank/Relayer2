...
| API 8개 (당사자·사례 생성 · 인테이크 · 상담 일정 등록 · 사례 조회 · 회차 기록 · 15초 다시보기 · 당사자 목록 · 일정 목록) | 있음 |
| 카드 4종, 결과 5종, `unchecked` 자동 기록, 목표 이어받기 | 있음 |
| PII 금고 AES-256-GCM | 있음 |
| 화면 7개: 다가오는 상담 · 당사자 · 당사자 등록 · 인테이크 작성하기 · 상담 일정 등록 · 상담 기록하기 · 15초 다시보기 | 있음 (Vite React SPA, 이식 CSS 1,831줄 + 질문지 423줄) |
